...
class AntiCollisionMode(Enum):
    ...
    FRONTAL = 3 #Stop when an obstacle is detected in front of the robot not implemented

class AntiCollisionHandle(Enum):
    CHANGE_DIRECTION = 0 # Change direction when an obstacle is detected not implemented
